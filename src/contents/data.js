let data=[
  ...
  {id:'React',links:[{linkTo:'my_portfolio-react',title:'This portfolio itself'}]},
  // {id:'Angular',links:[{linkTo:'default_app-angular',title:'A Default App'}]},
  {id:'Python',links:[{linkTo:'hangman_game-python',title:'The Hangman Game'},{linkTo:'book_scraping_app-python',title:'A Book Scraping App'}]},
];
